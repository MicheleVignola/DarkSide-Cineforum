...
<%
	ArrayList<Film> suggerimenti = (ArrayList<Film>) request.getAttribute("suggerimenti");
%>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
		<title>Suggerimenti Film</title>
		<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
		<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
		<link rel="stylesheet" href="css/navbar.css">
		<link rel="stylesheet" href="css/suggerimenti.css">
	</head>
	<body>
		<%@ include file="navbar.jsp" %>
		<div id="film" class="container h-auto mt-4">
			<div class="mx-auto text-center">
				<h1>Suggerimenti Film</h1>
			</div>
			<div class="row">
				<% for(Film film : suggerimenti) {%>
